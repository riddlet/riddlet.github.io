...
Great. Having done this, we can use the `mvrnorm` function to turn this into observed variables. This function takes a minimum of three arguments - the number of observations, the mean of each variable, and the matrix we just created and returns vectors of observations for each variable you're generating.  Here's an example:
