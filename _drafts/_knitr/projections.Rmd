...
```{r}
df.pit[1:20,c(1:3, 15:20)])
```

This seems about right.  Unfortunately, it doesn't rank relievers quite right.  We need to go way down to number 48 to find the top ranked reliever.

```{r}
df.pit[40:50, c(1:3, 15:20)]
```
